...
import { ShieldCheck, Lock, CheckCircle2, AlertCircle, X, ArrowRight, Loader2, FileText, Upload } from 'lucide-react';
              ...
              <div style={{ marginBottom: '12px' }}>
                <div style={{
                  ...
                  <input
                    ...
                    style={{ display: 'none' }}
                    id="modal-form16-compact-input"
                  />
                  <label
                    htmlFor="modal-form16-compact-input"
                    style={{
                      display: 'inline-flex',
                      alignItems: 'center',
                      gap: '5px',
