...
export default function CreatePropertyForm({ landlord, onClose, onSuccess }) {
  ...
  return (
    <div className="animate-fade-in" id="create-property-form-container" style={{ width: '100%', marginBottom: '40px' }}>
      {/* Top Header */}
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '22px' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                ...
                <label
                  htmlFor="multi-photo-upload-input-form"
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: '6px',
                ...
                <input
                  ...
                  style={{ display: 'none' }}
                  id="multi-photo-upload-input-form"
                />
              </div>
